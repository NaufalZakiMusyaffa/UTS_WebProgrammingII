    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data Buku</h3> <div class="btn-group float-right"><a href="" class="btn float-right btn-xs btn btn-primary">Tambah Buku</a><a href="" class="btn float-right btn-xs btn btn-info">Laporan Buku</a><a href="" class="btn float-right btn-xs btn btn-warning">Lihat Laporan Buku</a></div>
        </div>
        <div class="card-body">
          ...
          <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>contoh3</td>
                      <td>contoh4</td>
                      <td><div class="badge badge-warning">contoh5</div></td>
                      <td>contoh6</td>
                      <td>
